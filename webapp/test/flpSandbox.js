		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "invoice",
									"targetURL": "#invoiceinvoiceprueba-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoiceinvoiceprueba-display": {
								"semanticObject": "invoiceinvoiceprueba",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoice.invoiceprueba",
									"url": sap.ui.require.toUrl("invoice/invoiceprueba")
								}
							}
						}
					}
